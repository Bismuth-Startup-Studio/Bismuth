  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col gap-[80px] w-[70vw] py-10 md:py-[115px] px-10 md:px-[100px] bg-white m-auto -mt-[250px] rounded-md">
            <p className="font-news-reader text-[20px] lg:text-[32px] italic font-[500] text-center leading-[1.2]">"There has never been a better time to drive the next change through ideas and our mission is to encourage more people to choose entrepreneurship. The world can be better when more people build the future we want together."</p>
            <span className="text-center font-news-reader text-[32px] font-[300] italic">- The Bismuth Team</span>
        </div>
    </section>
  )
}
