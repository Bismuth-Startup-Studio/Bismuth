    ...
    <section>
        <Header>
            <div className='px-app-padding mt-[100px] md:mt-[200px] pb-[100px]'>
                ...
                <p className='paragraph text-[24px] font-[300] leading-[28.8px] mt-[30px]'>We are actively committed to fostering and supporting innovative tech-based solutions that align with the Sustainable Development Goals (SDGs), empowering ideas and concepts that address global challenges.</p>
            </div>
        </Header>
    </section>
  )
